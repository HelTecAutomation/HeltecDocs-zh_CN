...
.. toctree::
   ...
   无线电传输协议资源 <radioshuttle_protocol_resource>
   硬件更新日志 <hardware_update_log>
   
相关官方资源
------------

- 引脚图和原理图请参考 `Turtle Board Hardware Update Logs <https://heltec-automation-docs.readthedocs.io/en/latest/stm32/turtle_board/hardware_update_log.html>`_。
...
- 工厂测试固件
   ...
   - `工厂测试源代码 <https://os.mbed.com/users/Helmut64/code/Turtle_RadioShuttle/>`_