...
该库使LoRaWAN 1.0.2协议与ESP32 Arduino一起运行。 只支持由 `HelTec Automation(TM) <heltec.org>`_ 生产的ESP32 + LoRa系列产品, 并且 `LoRa网关 <https://heltec.org/proudct_center/lora/lora-gateway/>`_ 是必需的。
